...
export const metadata: Metadata = {
  title: "Casale di Martignano - Hotel e Ristorante sul Lago",
  description: "Lussuoso hotel con ristorante sul Lago Martignano. Camere eleganti, cucina italiana raffinata e ospitalità autentica a Roma.",
  keywords: "hotel Roma, Lago Martignano, ristorante italiano, Casale, lusso, ospitalità",
  metadataBase: new URL("https://casaledimartignano.it"),
  alternates: {
    canonical: "https://casaledimartignano.it"
  },
  openGraph: {
    title: "Casale di Martignano - Lusso e Ospitalità sul Lago",
    description: "Scopri il nostro esclusivo hotel e ristorante sul Lago Martignano. Un'oasi di tranquillità con camere eleganti e cucina italiana autentica.",
    url: "https://casaledimartignano.it",
    siteName: "Casale di Martignano",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765368415772-rrmskgeq.jpg",
        alt: "Vista panoramica Casale di Martignano"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Casale di Martignano - Hotel e Ristorante",
    description: "Lussuoso hotel sul Lago Martignano con ristorante di cucina italiana.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765368415772-rrmskgeq.jpg"]
  },
  robots: {
    index: true,
    follow: true
